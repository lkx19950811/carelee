...
/**
 * @author leon
 * @date 2018-06-19 14:53
 * @desc
 */
public class RandomMock {
    static String[] firsname = { "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈",
            ...
            "墨", "哈", "谯", "笪", "年", "爱", "阳", "佟" };
    static String[] namelist = { "伟", "伟", "芳", "伟", "秀英", "秀英", "娜", "秀英", "伟",
            ...
            "德赫", "君平" };
    static String[] email = {"@123.cm","@163.com","@qq.com","@gmail.com","@foxmail.com"};
    ...
    public static String maekEmail(){
        Random random = new Random();
        int a = (int) Math.abs(email.length * Math.random());
        return (Math.abs(random.nextInt(999999) + 100000)) + email[a];
    }
}
