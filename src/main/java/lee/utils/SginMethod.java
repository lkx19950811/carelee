 ...
 *
 * @author Leo
 * @create 2018-01-11 上午 1:10
 */
public class SginMethod {
    public static String signTopRequest(Map<String, String> params, String secret, String signMethod) throws IOException, NoSuchAlgorithmException {
        ...
        for (String key : keys) {
            ...
            if (StringUtils.isEmptyOrWhitespaceOnly(key)||StringUtils.isEmptyOrWhitespaceOnly(value)) {
    ...
    public static String byte2hex(byte[] bytes) { // byte to hex
